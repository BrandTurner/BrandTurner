...
//            }
        ...
        jst: {
            compile: {
                options: {
                    ...
                    namespace: 'BrandTurner.Templates'
                },
                files: {
    ...
    grunt.registerTask('createDefaultTemplate', function () {
        grunt.file.write('app/scripts/tmp/templates.js', 'window.BrandTurner = window.BrandTurner || {}; window.BrandTurner.Templates = window.BrandTurner.Templates || {};');
    });
